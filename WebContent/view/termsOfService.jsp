	...
	<div id = "wrapper">
		...
		<div id="contents">
			<div class="members">
				    ...
				    <ul class="ls_01">
				          <li>본 약관은 한국비전기술 (주) 가 운영하는 웹 사이트 (http://223.171.34.80/member/main.jsp)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.</li>
				    </ul>
				      
				    <h6 class="ti">제 2 조 (용어의 정의)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 3 조 (약관의 공시 및 효력과 변경)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 4 조 (약관 외 준칙)</h6>
				    <ul class="ls_01">
				    	<li>본 약관에 명시되지 않은 사항이 전기통신기본법, 전기통신사업법, 정보통신촉진법, ‘전자상거래등에서의 소비자 보호에 관한 법률’, ‘약관의 규제에관한법률’, ‘전자서명법’, ‘정보통신망 이용촉진등에 관한 법률’, ‘소비자보호법’ 등 기타 관계 법령에 규정되어 있을 경우에는 그 규정을 따르도록 한다.</li>
				    </ul>
				      
				    <h5 class="ti">제 2 장 총칙</h5>
				    <h6 class="ti">제 5 조 (이용신청)</h6>
				    <ul class="ls_01">
				    ...
				    <h5 class="ti">제 3 장 계약 당사자의 의무</h5>
				    <h6 class="ti">제 7 조 (회사의 의무)</h6>
				    <ul class="ls_01">
				    ...
				    <h5 class="ti">제 4 장 서비스의 제공 및 이용</h5>
				    <h6 class="ti">제 9 조 (서비스 이용)</h6>
				    <ul class="ls_01">
				    	<li>①이용자는 본 약관의 규정된 사항을 준수해 사이트를 이용한다.</li>
				        <li>②본 약관에 명시되지 않은 서비스 이용에 관한 사항은 회사가 정해 '공지사항'에 게시하거나 또는 별도로 공지하는 내용에 따른다.</li>
				    </ul>
				      
				    <h6 class="ti">제 10 조 (정보의 제공)</h6>
				    <ul class="ls_01">
				    	<li>회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보에 대하여 전자메일이나 서신우편 등의 방법으로 회원에게 정보를 제공할 수 있다.</li>
				    </ul>
				      
				    <h6 class="ti">제 11 조 (광고게재)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 12 조 (서비스 이용의 제한)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 13 조 (서비스 제공의 중지)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 14 조 (게시물 관리)</h6>
				    <ul class="ls_01">
				    	<li>회사는 건전한 통신문화 정착과 효율적인 사이트 운영을 위하여 이용자가 게시하거나 제공하는 자료가 제12조에 해당한다고 판단되는 경우에 임의로 삭제, 자료이동, 등록거부를 할 수 있다.</li>
				    </ul>
				     
				    <h6 class="ti">제 15 조 (서비스 이용 책임)</h6>
				    <ul class="ls_01">
				    	<li>이용자는 회사에서 권한 있는 사원이 서명한 명시적인 서면에 구체적으로 허용한 경우를 제외하고는 서비스를 이용하여 불법상품을 판매하는 영업활동을 할 수 없으며 특히 해킹, 돈벌기 광고, 음란 사이트를 통한 상업행위, 상용 S/W 불법제공 등을 할 수 없다. 이를 어기고 발생한 영업활동의 결과 및 손실, 관계기관에 의한 구속 등 법적 조치 등에 관해서는 회사가 책임을 지지 않는다.</li>
				    </ul>
				     
				    <h5 class="ti">제 5 장 기타</h5>
				    <h6 class="ti">제 16 조 (면책 및 손해배상)</h6>
				    <ul class="ls_01">
				    ...
				    <h6 class="ti">제 17 조 (개인신용정보 제공 및 활용에 대한 동의서)</h6>
				    <ul class="ls_01">
				    	<li>회사가 회원 가입과 관련해 취득한 개인 신용 정보는 신용정보의 이용 및 보호에 관한 법률 제23조의 규정에 따라 타인에게 제공 및 활용 시 이용자의 동의를 얻어야 한다. 이용자의 동의는 회사가 회원으로 가입한 이용자의  신용정보를 신용정보기관, 신용정보업자 및 기타 이용자 등에게 제공해 이용자의 신용을 판단하기 위한 자료로서 활용하거나 공공기관에서 정책자료로 활용하는데 동의하는 것으로 간주한다.</li>
				    </ul>
				      
				    <h6 class="ti">제 18 조 (분쟁의 해결)</h6>
				    <ul class="ls_01">
				    ...
				    <strong>부 칙</strong>
				    <ul class="ls_01">
          				<li>본 약관은 2020년 11월 19일부터 적용한다.</li>
      				</ul>
      			</div>	
		</div>
	</div>
